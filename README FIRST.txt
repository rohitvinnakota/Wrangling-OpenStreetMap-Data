For this project, I chose my city of Edmonton, Alberta, Canada to audit.
...
2) I used the sample_testing file to test the data on a smaller 50 MB subset of the Edmonton OSM dataset. The attached sample file is not the same file used for testing
